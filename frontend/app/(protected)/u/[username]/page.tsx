                        ...
                        <div className="flex gap-3 mb-2 w-full md:w-auto">
                            {!isOwnProfile ? (
                                <>
                                    ...
                                    <button className="px-4 py-3 bg-white text-slate-900 font-black border-2 border-slate-900 hover:bg-slate-50 transition-all">
                                        Message
                                    </button>
                                </>
                            ) : (
                        ...
                        {activeTab === 'overview' && (
                            <div className="space-y-8">
                                ...
                                <div className="bg-white border-2 border-slate-200 p-6">
                                    <h3 className="text-lg font-black text-slate-900 mb-4 uppercase">Earned Badges</h3>
                                    ...
                                    <p className="text-xs text-slate-400 font-medium mt-4 italic">Badges system coming soon.</p>
                                </div>
