    ...
    const sidebarLinks = [
        {
            ...
            href: "#",
            icon: <GlobeAltIcon className="h-5 w-5 flex-shrink-0" />,
        ...
        },
        {
            ...
            href: "#",
            icon: <SparklesIcon className="h-5 w-5 flex-shrink-0" />,
                ...
                {activeCircleType === 'community' && (
                    <div className="flex gap-3 mb-6">
                        <button
                            ...
                            className={`px-5 py-2 font-black uppercase tracking-widest border-4 border-slate-900 transition-all text-xs ${activeTab === 'explore'
                        ...
                        <button
                            ...
                            className={`px-5 py-2 font-black uppercase tracking-widest border-4 border-slate-900 transition-all text-xs ${activeTab === 'my-circles'
                                ? 'bg-slate-900 text-white shadow-[4px_4px_0px_0px_rgba(22,163,74,1)]'
                                : 'bg-white text-slate-500 hover:bg-slate-100'
                                }`}
                        >
                            ...
                            filteredRooms.map((room: any, index: number) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="bg-white border-4 border-slate-900 p-0 hover:shadow-[6px_6px_0px_0px_rgba(22,163,74,1)] transition-all duration-300 group flex flex-col relative"
                                    >
                                        ...
                                        {((activeTab === 'explore' && !isOwnCircle) || (activeTab === 'my-circles' && !isOwner)) && (
                                            <div className="absolute top-4 left-4 z-20">
                                                ...
                                                >
                                                    <EllipsisVerticalIcon className="w-4 h-4 text-slate-900" />
                                                </button>
                                        ...
                                        <div className="aspect-[4/3] bg-slate-100 relative border-b-4 border-slate-900 overflow-hidden">
                                            ...
                                            {room.avatar ? (
                                                ...
                                                <div className="w-full h-full flex items-center justify-center relative z-10">
                                                    <UserGroupIcon className="w-16 h-16 text-slate-400" />
                                                </div>
                                            )}
                                        </div>
                                            ...
                                            <div className="mt-auto w-full pt-4 border-t-4 border-slate-100">
                                                ...
                                                >
                                                    {(activeCircleType as string) === 'collab' || (activeCircleType as string) === 'opportunity' ? (
                                                        ...
                                                        <>Enter Circle <ArrowRightIcon className="w-3 h-3" /></>
                                                    ) : isPending ? (
                                                        'Requested'
                                                    ) : isMember ? (
                                                        <>Open Circle <ArrowRightIcon className="w-3 h-3" /></>
                                                    ) : (
                                                        'Join Circle'
                                                    )}
                                                </button>
