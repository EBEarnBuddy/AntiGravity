...
class Media {
    ...
    createShader() {
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          // Removed floating animation - keep cards flat
    ...
    onResize(
        ...
        const cardSize = (this.viewport.height * (600 * this.scale)) / this.screen.height; // Reduced from 700 to 600
        this.plane.scale.y = cardSize;
        this.plane.scale.x = cardSize; // Perfect square for circular display
