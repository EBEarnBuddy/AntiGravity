            ...
            <div className="relative w-full h-full">
                ...
                {!isAtBottom && (
                    <Button
                        ...
                        size="icon"
                        variant="outline"
                        className="absolute bottom-4 left-1/2 transform -translate-x-1/2 inline-flex rounded-full shadow-lg bg-white hover:bg-slate-50 border-2 border-slate-900"
